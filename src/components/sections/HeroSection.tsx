    ...
    <section className="min-h-screen flex flex-col justify-center px-4 md:px-6 pt-20">
      <div className="container mx-auto">
        <motion.div
          ...
          className="max-w-5xl"
        >
          <h1 className="heading-display text-[clamp(2.2rem,6vw,5.5rem)] leading-[1] mb-8">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-muted-foreground max-w-xl mt-8 mb-16 leading-relaxed"
        >
          Large-scale events, real-time execution, and critical problem solving.
        </motion.p>
